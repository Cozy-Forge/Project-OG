        ...
        while(_slate.fullHP)
        {
            ...
            switch (rand)
            {
                case 1:
                    ...
                    break;
                case 2:
                    NowCoroutine(_pattern.TornadoShot(_slate, g_minimis, 6, 5, 0.1f, 3, _slate.fullHP));
                    break;
                case 3:
                    NowCoroutine(_pattern.RandomMoveAttack(_slate, g_minimis, 6, 5, 2, 3, _slate.fullHP));
                    break;
                case 4:
                    NowCoroutine(_pattern.StopAndGoAttack(_slate, 10, 3, 1, 3, _slate.fullHP));
                    break;
            }
        }
    }
